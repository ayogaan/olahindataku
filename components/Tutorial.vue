<template>
  <!-- component -->
<!-- component -->
<footer class="w-auto p-4 bottom-0 h-auto relative bg-white ">
        <div class="lg:flex  lg:mt-3 md:mx-12 lg:mx-28 lg:justify-between">
            <div class="mb-4 lg:columns-1 w-96">
                <p class="mt-1 my-5 text-2xl font-extrabold tracking-wide uppercase lg:text-3xl">
                Olah Dataku
                </p>
            ...
            <div class="lg:mt-3 mb-4">
                ...
                <div class="columns-2 md:columns-3 lg:columns-2">
                    <a class="text-gray-500" href="">Home</a><br>
                    <a class="text-gray-500" href="">Marketplace</a><br>
                    <a href="" class="text-gray-500">Punya Token ?</a><br>
                    <a class="text-gray-500" href="">About Us</a><br>
        ...
        <div>
            <div class="flex justify-center mt-2">
                <p class="text-gray-600"> Copyright &copy;
