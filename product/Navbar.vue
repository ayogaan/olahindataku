<template>
  <!-- component -->
<nav class="bg-white backdrop-blur-md shadow-lg fixed w-full z-10">
			<div class="max-w-8xl mx-auto lg:px-8 px-4 ">
				<div class="flex justify-between">
					<div class="flex space-x-7">
						<div>
							<!-- Website Logo -->
							<a href="#" class="flex items-center py-4 px-2">
								<span class="lg:text-2xl font-extrabold tracking-wide uppercase">
        						Olah Dataku
      							</span>
							</a>
						</div>
					...
					<div class="hidden md:flex items-center space-x-3 ">
						<a href="" class="py-2 px-2 font-medium text-gray-500 rounded hover:bg-green-500 hover:text-white transition duration-300">Have Token ?</a>
					</div>
					<!-- Mobile menu button -->
